    ...
    <main className="min-h-screen bg-[#020617] text-white overflow-hidden">
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#020617]/85 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-5">
          <Link href="/" className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-blue-400 to-fuchsia-400">
            MatchMind AI
          </Link>
          ...
          <div className="hidden items-center gap-8 text-slate-300 lg:flex">
            ...
            <a href="#why" className="hover:text-white">Why it matters</a>
            <Link href="/signin" className="hover:text-white">Sign in</Link>
            <Link href="/signup" className="rounded-2xl bg-gradient-to-r from-blue-600 via-violet-600 to-fuchsia-500 px-6 py-3 font-black shadow-[0_0_35px_rgba(99,102,241,0.35)]">
              Get started
            </Link>
          </div>
        </div>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-2">
          <div>
            <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.06] px-5 py-3 backdrop-blur-xl">
              ...
              <span className="font-bold text-sky-300">AI Football Match Companion</span>
            </div>

            <h1 className="text-6xl font-black leading-[1.05] tracking-tight lg:text-7xl">
            ...
            <div className="mt-12 flex flex-wrap gap-5">
              <Link href="/signup" className="rounded-2xl bg-gradient-to-r from-blue-600 via-violet-600 to-fuchsia-500 px-10 py-5 text-xl font-black shadow-[0_0_45px_rgba(99,102,241,0.4)]">
                Start free
              </Link>

              <Link href="/analysis" className="rounded-2xl border border-white/10 bg-white/[0.06] px-10 py-5 text-xl font-black backdrop-blur-xl hover:border-sky-400">
                Try analysis
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative rotate-1 rounded-[36px] border border-white/10 bg-white/[0.06] p-8 shadow-[0_0_90px_rgba(14,165,233,0.18)] backdrop-blur-2xl transition hover:rotate-0">
              ...
              <div className="mt-6 rounded-3xl bg-gradient-to-r from-blue-600 via-violet-600 to-fuchsia-500 p-6">
                ...
                <p className="mt-2 text-slate-100">
                  Expect pressure, tactical changes, quick attacks, and momentum swings.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="mx-auto max-w-7xl px-8 py-24">
        ...
        <div className="grid gap-7 md:grid-cols-3">
          <Feature icon="⚽" title="Match Analysis" text="Generate tactical insight, team advantage, prediction, and fan summary." />
          <Feature icon="🤖" title="AI Assistant" text="Ask football questions and get simple fan-friendly explanations." />
          <Feature icon="📊" title="Explainable Results" text="Outputs are divided into clear sections for better understanding." />
          <Feature icon="🔥" title="Momentum Explainer" text="Understand pressure moments, substitutions, and tactical shifts." />
          <Feature icon="🧠" title="Smart Reasoning" text="AI adapts to before, during, and after match contexts." />
          <Feature icon="🎙️" title="Voice Ready" text="Designed for future voice-based match explanation experience." />
        </div>
      </section>
      ...
      <section id="how" className="bg-[#07111f] px-8 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-7 md:grid-cols-3">
            <Step n="01" title="Enter match" text="Choose teams and match stage: before, during, or after." />
            <Step n="02" title="AI analyzes" text="The system creates structured tactical reasoning." />
            <Step n="03" title="Fans understand" text="Users get simple predictions, insights, and summaries." />
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#07111f] px-8 py-24">
        <div className="mx-auto max-w-7xl rounded-[36px] bg-gradient-to-r from-blue-600 via-violet-600 to-fuchsia-500 p-14 text-center shadow-[0_0_80px_rgba(99,102,241,0.35)]">
          ...
          <Link href="/signup" className="mt-10 inline-block rounded-2xl bg-white px-10 py-5 text-xl font-black text-black">
            Create account
          </Link>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10 bg-[#020617] px-8 py-16">
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-4">
          ...
          <Footer title="Product" items={["Features", "Match Analysis", "AI Assistant", "Dashboard"]} />
          <Footer title="Company" items={["About", "Contact", "Support"]} />
          <Footer title="Legal" items={["Privacy Policy", "Terms of Service"]} />
        </div>
      </footer>
    </main>
  );
...
function PreviewCard({ title, value }) {
  return (
    <div className="rounded-3xl border border-white/10 bg-[#030712] p-6">
      ...
      <h3 className="mt-2 text-4xl font-black text-sky-400">{value}</h3>
    </div>
  );
}
...
function Panel({ type, title, items }) {
  ...
  return (
    <div className="rounded-[32px] border border-white/10 bg-white/[0.06] p-10 backdrop-blur-xl">
      <p className={`mb-4 font-black ${isProblem ? "text-red-400" : "text-sky-400"}`}>
