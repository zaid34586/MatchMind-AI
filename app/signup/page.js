  ...
  return (
    <div className="flex items-center justify-center">
      <div className="w-full max-w-xl rounded-[34px] border border-white/10 bg-white/[0.07] p-8 shadow-[0_0_90px_rgba(236,72,153,0.18)] backdrop-blur-2xl">
        ...
        <div className="mt-10">
          <p className="font-black text-sky-400">Start free</p>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3 text-sm text-slate-300">
          <Feature text="Match Analysis" />
          <Feature text="AI Assistant" />
          <Feature text="Before Match" />
          <Feature text="After Match" />
        </div>

        <p className="mt-8 text-center text-slate-300">
          Already have an account?{" "}
          <Link href="/signin" className="font-black text-sky-400">
            Sign in
          </Link>
        </p>
      </div>
